...
// annotation-asset-catalog-id 検証実施時、同一マシン上の並列レーン負荷で load average が
// 90+ に達することがあり、既定 15s では正常な CDP 応答すら timeout することを実測したため
// 45s に引き上げた（catalog-tab (2026-07-25) の cdp-lib.mjs からのこの1点のみの差分）。
